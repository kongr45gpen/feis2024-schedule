...
\end{centering}

    {
        \begin{tikzpicture}
            ...
            \node[fill=white] at (current bounding box.east -| 0,0) {\qrcode[height=2cm]{https://feis2024.uni.lu/schedule?s=qr&qrv=0.25}};
        \end{tikzpicture}%
    }

    \noindent%
    \shadowcolor{black}
    \parbox{.333\textwidth}{\color{white}\footnotesize Version 0.25}%
