...
\end{centering}

    {
        \begin{tikzpicture}
            ...
            \node[fill=white] at (current bounding box.east -| 0,0) {\qrcode[height=2cm]{https://feis2024.uni.lu/qr}};
        \end{tikzpicture}%
    }

    \noindent%
    \shadowcolor{black}
    \parbox{.333\textwidth}{\color{white}\footnotesize Version 0.14}%
...
\begin{tcolorbox}[
    ...
    \begin{tikzpicture}
        ...
        \foreach \i in {0,1,2,3} {
            \ifnum \i = 0
                \def\basecolor{MaterialGreen600}
            \else
...
%
            ...
            \node[anchor=south] (S) at (current bounding box.west -| 0,0) {\timeregularfont\Large 18:00 };
            \node[anchor=north] (E) at (current bounding box.west -| 0,0) {\timelightfont\textendash~ 19:30 };    
...
\begin{tcolorbox}[width=\linewidth,center,boxrule=0pt,arc=0pt,auto outer arc,colframe=white,breakable,height fixed for=all]
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=west,text width=\width,align=left,minimum height=1.3cm] (T) at (\x,0) {\mediumfont%
            Keynote Lecture 1: Pete Worden (Breakthrough Initiatives): Life in the Universe and Private Sector Space Science Initiatives%
            %\ \texttt{TSTQQY}%
            %
            %
            };
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=west,text width=\width,align=left,minimum height=1.3cm] (T) at (\x,0) {\mediumfont%
            Keynote Lecture 2: Harry Atwater (California Institute of Technology): StarShot - from physics to spacecraft%
            %\ \texttt{3XGUSA}%
            %
            %
            };
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \fill[rounded corners=1mm,gray!50!white]
            (1,-0.7) rectangle (16.2,0.7) node[pos=.5,gray!50!black] {\mediumfont Coffe break};

            \node[anchor=south] (S) at (current bounding box.west -| 0,0) {\timeregularfont\Large 14:20 };
            \node[anchor=north] (E) at (current bounding box.west -| 0,0) {\timelightfont\textendash~ 14:50 };     
    ...
    %%
                ...
                \node[] (S) at (A1 -| 0,0) {\timeregularfont\Large 14:50 };
    ...
    %%
                ...
                \node[] (S) at (A2 -| 0,0) {\timelightfont\large 15:10 };
    ...
    %%
                ...
                \node[] (S) at (A3 -| 0,0) {\timelightfont\large 15:30 };
    ...
    %%
                ...
                \node[] (S) at (A4 -| 0,0) {\timelightfont\large 15:50 };
    ...
    %%
                ...
                \node[] (S) at (A5 -| 0,0) {\timelightfont\large 16:10 };
    ...
    %%
                ...
                \node[] (S) at (A6 -| 0,0) {\timelightfont\large 16:30 };
                

            

            % Draw rounded rectangle next to that
            \fill[rounded corners=1mm,thistrack] (A1.north west -| 1,-1) rectangle (A6.south west -| 1.2,1) {};
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=south] (S) at (current bounding box.west -| 0,0) {\timeregularfont\Large 16:50 };
            \node[anchor=north] (E) at (current bounding box.west -| 0,0) {\timelightfont\textendash~ 17:50 };    
...
\begin{tcolorbox}[width=\linewidth,center,boxrule=0pt,arc=0pt,auto outer arc,colframe=white,breakable,height fixed for=all]
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=west,text width=\width,align=left,minimum height=1.3cm] (T) at (\x,0) {\mediumfont%
            Keynote Lecture 3: Paolo Villoresi (University of Padova): Harnessing the light emission for extreme space optical communication%
            %\ \texttt{38CABN}%
            %
            %
            };
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=west,text width=\width,align=left,minimum height=1.3cm] (T) at (\x,0) {\mediumfont%
            Keynote Lecture 4: Martin Tajmar (TU Dresden): Overview of Breakthrough Propulsion at TU Dresden%
            %\ \texttt{AT8ECC}%
            %
            %
            };
    ...
    %%
                ...
                (A6) at (A5.south west)
                {\mediumfont%
                Evolutionary Neurocontrol for Low Thrust Solar Oberth Maneuvers to the Heliopause%
                %
    \\[0ex]%
    {\color{gray}\footnotesize%
        %
...
\begin{tcolorbox}[width=\linewidth,center,boxrule=0pt,arc=0pt,auto outer arc,colframe=white,breakable,height fixed for=all]
    ...
    \begin{tikzpicture}
        ...
        \node at (-1,0) {}; % Alignment node for bounding box
            ...
            \node[anchor=west,text width=\width,align=left,minimum height=1.3cm] (T) at (\x,0) {\mediumfont%
            Keynote Lecture 5: Mona Nasser (University of Plymouth): Voyaging Through the Vast — Transforming Clinical Research Methods for Interstellar Expeditions%
            %\ \texttt{N3FEYP}%
            %
            %
            };
...
\end{center}
    ...
    \begin{tcolorbox}[
        enhanced,
        title={Keynote Lecture 2: Harry Atwater (California Institute of Technology \\  StarShot \textemdash~from physics to spacecraft},
        sharp corners,
        colbacktitle=thistrack,
        fonttitle=\large\mediumfont,
        boxsep=0pt,
